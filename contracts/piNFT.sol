...
contract piNFT is ERC721URIStorage{
    ...
    external {
        ...
        address poolAddress = LibPool.deployPoolAddress(msg.sender, target, interestRate, lateInterestRate, lateInterestRateDeadLine, rePayStartDate, totalRepayDeadLine);
